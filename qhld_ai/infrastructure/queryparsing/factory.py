...
from qhld_ai.domain.ports.query_parser import QueryParserPort
...
# (spaCy/dateparser are lazy inside parse), so this stays cheap even when they are
# not installed.
from qhld_ai.infrastructure.queryparsing import llm, rule_based  # noqa: E402, F401
