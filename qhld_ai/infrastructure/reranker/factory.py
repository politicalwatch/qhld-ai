...
server (a vMLX engine, ...); "jina" calls Jina's hosted rerank API; "cohere"
and "voyage" call those vendors' hosted rerank models through their own SDKs
(via langchain-cohere / langchain-voyageai).
"""
